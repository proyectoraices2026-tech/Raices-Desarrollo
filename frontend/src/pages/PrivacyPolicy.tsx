...
/* Página pendiente de contenido (tarea #7 del backlog: redactar política de privacidad).
  ...
  return (
    <div className="min-h-screen bg-[#f5f7f2] p-6">
      ...
      <div className="md:max-w-3xl md:mx-auto">
        <h1 className="text-2xl font-bold text-[#1e2d24] mb-4">Política de privacidad</h1>
