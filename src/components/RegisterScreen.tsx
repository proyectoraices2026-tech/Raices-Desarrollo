...
export function RegisterScreen({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onRegisterSubmit({ firstName, lastName, email, password });
  };

  return (
    <div className="min-h-screen bg-[#DFE5DC] flex flex-col justify-between p-6 md:p-12 relative">
      
      {/* Botón Superior con ícono de flecha dentro de un círculo */}
      ...
      <div className="w-full max-w-sm mx-auto my-auto py-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Fila de Nombres: First Name y Last Name */}
        ...
        <p className="text-center text-xs font-medium text-[#2D4A3E]/80 mt-6 leading-relaxed">
          ...
          <a href="#" className="font-semibold text-[#2D4A3E] underline">
            Terms of Service
          </a>{' '}
          and{' '}
          <a href="#" className="font-semibold text-[#2D4A3E] underline">
